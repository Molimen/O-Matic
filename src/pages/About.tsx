    ...
    <>
      ...
      <section className="text-center">
        <div className="h-57.75 w-75 mx-auto mb-8 flex justify-center items-center z-0">
            <svg ref={svgRef} width="300" height="231" viewBox="0 0 510 393" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute h-62.5 z-20">
                <g id="Group 11">
            ...
            <svg width="300" height="231" viewBox="0 0 510 393" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute h-62.5 z-10">
                <g id="Group 11">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-6 bg-clip-text text-transparent bg-linear-to-b from-on-background to-on-surface-variant text-balance">
          Architects of the <mark className="text-transparent bg-clip-text bg-linear-to-b from-secondary-dim from-20% via-primary to-90% to-blue-800 leading-relaxed">O-Matic</mark>
        </h1>
        <p className="text-on-surface-variant text-lg md:text-xl max-w-2xl mx-auto font-light px-2 text-balance leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 px-6 mt-12">
        ...
        <div className="glass-panel rounded-lg p-8 px-6 md:p-12 relative overflow-hidden group border border-surface-container-highestest">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-8">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-8 text-left min-h-50">
                A programming enthusiast trying to learn! In this project I focus on frontend structures. Also, I'm skilled in C, Python,
                HTML, CSS, JS.
                <br />
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left gap-8">
            ...
            <div>
              ...
              <p className="text-on-surface-variant leading-relaxed mb-8 text-left min-h-50">
                ...
                working on the design (thanks to figma for helping me visualizing this design)
                and coded some frontend logics.
                <br />
